...
const investigacionData = [
  ...
  },
  {
    ...
    content: `
      ...
      <a
        href="/REGLAMENTO_DE_INVESTIGACION"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
      >
 ...
 //   title: "Proyectos de Investigación e Innovación en el Tecnológico Superarse",
  ...
  //},
  {
    ...
    content: `
      ...
      <p>
        Como parte del fortalecimiento de las funciones sustantivas de los Institutos Técnicos y Tecnológicos,
         nuestro Instituto Superior Tecnológico Superarse, representando por la Rectora de la Institución MSc.
          Verónica Tamayo, estuvo presente en la “Red de Investigación de Instituciones de Educación Superior Técnicas
           y Tecnológicos (RIESTT)”.
      </p>
      <p>
...
<img src="/assets/img/Investigacion/Investigacion2.png" alt="Descripción de la imagen 2" style="width: 100%; height: auto;">
  ...
  },
  {
    ...
    content: `
    <div>
 <img src="/assets/img/Investigacion/CongresoII.jpeg" alt="Congreso II" style="width: 100%; height: auto; margin-bottom: 15px;">
      ...
      sostenible de la industria.El congreso se estructuro en seis ejes temáticos que guiarán las discusiones y aportes de los participantes:
      </p>
      <ul>
  ...
  },
  {
    ...
    content: `
    <div>
 <img src="/assets/img/Investigacion/congreso.png" alt="Descripción de la imagen 1" style="width: 100%; height: auto; margin-bottom: 15px;">
      ...
      <p>La topografía es una disciplina esencial para el estudio detallado de la superficie terrestre. Abarca desde los 
      ...
      precisa del terreno en planos o mapas a escala.</p>
      <p>Por su parte, la geodesia se enfoca en el análisis de la forma y dimensiones de la Tierra, incluyendo la determinación
      de su campo gravitatorio y la exploración del fondo oceánico. También estudia la orientación y posición del planeta en el
      espacio, aportando información clave para diversas áreas científicas y tecnológicas.</p>
      <p>Memorias del Primer Congreso Internacional de Topografía y Geodesia 2023 han sido publicadas en la revista científica "Conectividad", en el Vol.4 N°2, del ISTER</p>
      <a
        href="https://revista.ister.edu.ec/ojs/index.php/ISTER/article/view/104"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
  ...
  },
  {
    ...
    content: `
    <div>
 <img src="/assets/img/Investigacion/equino.png" alt="Descripción de la imagen 1" style="width: 100%; height: auto; margin-bottom: 15px;">
</div>
  ...
  },
  {
    ...
    content: `
      ...
      <a
        href="/PLANIFICACION_GESTION_INVESTIGACION"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
      >
  ...
  },
  {
    ...
    <li>Dirección de Investigación, Desarrollo e Innovación: <a href="mailto:investigacion@superarse.edu.ec">Josue Tello</a></li>
      ...
      <p>Por favor, asegúrese de enviar los documentos del proyecto con copia a la coordinación de cada escuela a la que pertenezca:</p>
      <p>
      ...
      <li><strong>Escuela en linea:</strong>  Para contactar directamente al responsable del área, envíe un correo a:<a href="mailto:katherine.guaman@superarse.edu.ec">Katherine Guaman</a> </li>
...
<a class="doc-btn azul" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-003 Perfil de Propuesta de investigación.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Perfil de Propuesta de Investigación
</a>

<a class="doc-btn verde" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-004 Plan de Aprendizaje de Estudiantes.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Plan de Aprendizaje de Estudiantes
</a>

<a class="doc-btn amarillo" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-005 Matriz de evaluación de perfiles de investigación.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Matriz de Evaluación de Perfiles
</a>

<a class="doc-btn naranja" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-006 Carta de compromiso de estudiantes en investigación_SP 1.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Carta de Compromiso
</a>
...
<a class="doc-btn azul" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-007 Acta de inicio de proyecto de investigación_SP.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Acta de Inicio
</a>
...
<a class="doc-btn verde" 
   href="/assets/docs/Investigacion/Proyectos/ISTS-GIDIVS-02-008 Seguimiento proyectos de investigación_SP.docx" 
   download>
    <i class="fa fa-file-word"></i>
...
<a class="doc-btn amarillo" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-009 Proyecto final de investigación_SP.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Proyecto Final
</a>
...
<a class="doc-btn naranja" 
   href="/assets/docs/Investigacion/Formatos/ISTS-GIDIVS-02-010 CIERRE DE PROYECTO_FORMATO-INFORME.docx" 
   download>
    <i class="fa fa-file-word"></i>
    Cierre de Proyecto
</a>
  ...
  },
  {
  ...
  },
   {
    ...
    content: `
      ...
      <p>Los cuyes (Cavia porcellus) han sido consumidos y venerados en los países sudamericanos desde tiempos precolombinos,
      ...
      <p>El presente estudio trata sobre la pertinencia del profesional en Instrumentación Quirúrgica en Ecuador y se arraiga en las 
      ...
      cirugías, y de esta manera se reconozca el rol de este profesional en el país. Para la metodología se aplicó un tipo de investigación 
      bibliográfica para la recopilación de datos nacionales e internacionales acerca del instrumentista quirúrgico, así como, 
      el método cuantitativo mediante la realización de encuestas para conocer la demanda ocupacional de estos profesionales en los 
      centros de salud en Pichincha. Con lo cual, se evidencia que en el Ecuador el rol del instrumentista quirúrgico no es reconocido como 
      en otros países latinoamericanos, como Colombia, Brasil, Bolivia,entre otros; el mismo que es importante para las prácticas 
      quirúrgicas seguras; por ello, en correspondencia con las encuestas 
    ...
    content: `
      ...
      <p>Este libro destaca la importancia de la formación práctica en la carrera de Producción Animal, donde los estudiantes del Instituto Superior Tecnológico Superarse (ISTS) fortalecen sus conocimientos teóricos a través de talleres aplicados al ámbito agroindustrial.</p>
      <a
        href="/ESTUDOS_EM_CIENCIAS_AGRARIAS"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
      >
        <i class="fa fa-file-pdf mr-2"></i> Ver Publicación
      ...
      <h4>Primer Congreso Internacional De Innovación, Tecnología, Patrimonio
y sostenibilidad O. D. S.</h4>
      <p>
        <strong>Emergentes por:</strong> César Andrés Ramírez Romero .
      </p>
      <p>Este libro presenta un estudio innovador orientado al aprovechamiento sostenible de los residuos agroindustriales, tomando como caso el mucílago de cacao, un subproducto generado durante la poscosecha del grano.</p>
      <a
        href="/CONGRESO_ITPS_ODS"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
      >
        <i class="fa fa-file-pdf mr-2"></i> Ver Publicación
  ...
  },
  {
    ...
    content: `
      ...
      <p>La ponencia destaca la importancia del employer branding como un componente esencial para el éxito empresarial, 
      especialmente en los emprendimientos emergentes. Establecer estrategias de employer branding es crucial para atraer, 
      retener talento y construir una reputación positiva como empleador.</p>
      <a
      ...
      <p>El libro de “Humanidades e Ciências Sociais” reúne investigaciones sobre educación, problemáticas sociales y empresas, destacando el uso de nuevas tecnologías como redes sociales, enseñanza híbrida e inteligencia artificial.</p>
      <a
        href="/HUMANIDADES_E_CIENCIAS_SOCIAIS"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
      >
        <i class="fa fa-file-pdf mr-2"></i> Ver Publicación
      ...
      <p>El libro de topografía subterránea, abordando tanto los aspectos técnicos como los desafíos propios de este campo especializado. Su contenido combina fundamentos teóricos, técnicas aplicadas y normativas nacionales e internacionales, proporcionando una base sólida para su aplicación en proyectos subterráneos.</p>
      <a
        href="/TOPOGRAFIA_SUBTERRANEA"
        target="_blank"
        class="btn btn-sm btn-info mt-3"
      >
        <i class="fa fa-file-pdf mr-2"></i> Ver Publicación
      ...
      <h4>Libros y Guías de Estudio</h4>
        ...
        <div id="matematicas-viewer" class="pdf-viewer" style="display:none; margin-top: 15px;">
          ...
          <iframe src="/assets/docs/Investigacion/Guia/GUÍA GENERAL DE ESTUDIO DE MATEMÁTICAS.pdf" width="100%" height="500px" style="border: none;"></iframe>
        </div>
        ...
        <div id="publicidad-viewer" class="pdf-viewer" style="display:none; margin-top: 15px;">
          ...
          <iframe src="/assets/docs/Investigacion/Guia/GUÍA GENERAL DE ESTUDIO DE PUBLICIDAD DIGITAL.pdf" width="100%" height="500px" style="border: none;"></iframe>
        </div>
        ...
        <div id="reglamento-viewer" class="pdf-viewer" style="display:none; margin-top: 15px;">
          ...
          <iframe src="/assets/docs/Investigacion/Guia/GUÍA GENERAL DE ESTUDIO DE.pdf" width="100%" height="500px" style="border: none;"></iframe>
        </div>
  ...
  },
  {
    ...
    content: `
      ...
      <p>
        ...
        y cartografía; además, investigadores autónomos, topógrafos, ingenieros, arquitectos, geólogos y otros profesionales 
    ...
    content: `
      ...
      <p>
        ...
        of the total annual anthropogenic greenhouse (GHG) emissions. Pasture for cattle grazing is the dominant agricultural
         ...
         developing countries are changing rapidly in response to a variety of drivers. Therefore, globally, natural 139 forest
