...
<head>
    ...
    <title>Solicitud Cambio de Malla</title>
...
<body class="flex flex-col items-center">
    ...
    <div id="documento" class="shadow-2xl max-w-[794px]">
        ...
        <div class="p-8 text-gray-800 flex-grow text-sm">
            ...
            <div class="text-justify leading-relaxed">
               ...
               <strong> <input type="text" id="nombrePrincipal" placeholder="Nombres y apellidos Completos" class="w-80 mx-1 border-b"></strong>
                ...
                , actualmente me encuentro matriculado/a en el
            ...
            <p class="mt-5">Por la atención brindada, anticipo mis agradecimientos.</p>
            ...
            <div class="mt-6 border border-gray-400 rounded-md p-3">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        <p class="font-bold">Vicerrectorado Académico</p>
                        <p>Instituto Superior Tecnológico Superarse</p>
                        <p class="text-blue-600">matricular@superarse.edu.ec</p>
                    </div>
        ...
        <!-- FOOTER -->
        <div class="footer-band w-full h-16 bg-gradient-to-r from-[#005a9c] via-[#0088cc] to-[#4299e1]
            flex justify-between items-end px-6 py-3 text-white text-[10px] flex-none">
            <p>Página 1 de 1</p>
            <p class="text-right">
                ISTS-GD-02-009<br>
                Versión: 001<br>
    ...
    <button onclick="descargarPDF()"
        class="my-8 px-10 py-4 bg-green-600 text-white rounded-full font-bold shadow-2xl hover:bg-green-700 transition-all">
        Descargar Solicitud Cambio de Malla
    </button>
