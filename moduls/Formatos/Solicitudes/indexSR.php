...
<head>
    ...
    <title>Solicitud de Reingreso</title>
...
<body class="flex flex-col items-center">
    ...
    <div id="documento" class="shadow-2xl">
        ...
        <div class="p-10 text-gray-800 flex-grow">
            <h1 class="text-sm font-bold text-center mb-6 uppercase">Solicitud de Reingreso</h1>
            ...
            <div class="document-text text-justify leading-relaxed text-sm">
                ...
                , solicito de manera especial se me autorice el reingreso en la carrera de 
            ...
            <p class="mt-3 font-bold">Atentamente,</p>
